      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="font-playfair text-4xl md:text-5xl font-bold text-white mb-5 tracking-tight leading-[1.1]">
            Jaclyn Didn&apos;t Study This Problem.{' '}
            <span className="text-teal-400">She Built Her Career Solving It.</span>
          </h2>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-14 items-start">
          ...
          <div className="flex flex-col items-center lg:items-start gap-6">
            <div className="relative w-64 h-64 lg:w-80 lg:h-80 rounded-2xl overflow-hidden border border-teal-900/40 shadow-2xl shadow-black/40 flex-shrink-0">
              <Image
                src="/jaclyn-headshot.png"
                alt="Jaclyn McDuff — CFO & Co-Founder, AiMpact Technology"
                fill
            ...
            <div className="text-center lg:text-left">
              <p className="font-playfair text-white font-bold text-2xl">Jaclyn McDuff</p>
              <p className="text-teal-400 text-sm font-medium mt-0.5">CFO &amp; Co-Founder — AiMpact Technology</p>
              <p className="text-zinc-500 text-sm mt-1">Houston, TX</p>
            </div>

            <blockquote className="border-l-2 border-teal-500 pl-5 max-w-sm">
