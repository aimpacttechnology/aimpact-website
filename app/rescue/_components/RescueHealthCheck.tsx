      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-5 tracking-tight leading-[1.1]">
            ...
            <span className="text-amber-400">Spreadsheet Health Check?</span>
          </h2>
          ...
          {steps.map((step, i) => (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <span className="text-4xl font-bold text-amber-500/20 leading-none select-none">
                  {String(i + 1).padStart(2, '0')}
                </span>
                <h3 className="text-xl font-bold text-white">{step.verb}</h3>
              </div>
        ...
        <div className="mt-8 text-center">
          ...
          <p className="mt-3 text-zinc-600 text-sm">Delivered within 5 business days. Includes a PDF report and optional video walkthrough.</p>
        </div>
      </div>
    </section>
  )
