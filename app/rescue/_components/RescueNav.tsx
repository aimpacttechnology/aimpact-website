      ...
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        <a href="/" className="flex items-center gap-2">
          ...
          <span className="font-bold text-white tracking-tight">
            AiMpact<span className="text-amber-500">.</span>
          </span>
        </a>
        ...
        <a
          ...
          className="group inline-flex items-center gap-2 px-5 py-2.5 bg-amber-600 hover:bg-amber-500 text-white font-semibold text-sm rounded-xl transition-all duration-200"
        >
