        ...
        <div className="max-w-4xl mx-auto px-6 pt-28 pb-16 space-y-6">
          ...
          <div className="flex items-center gap-3 bg-green-500/10 border border-green-500/20 rounded-xl px-5 py-3">
            ...
            <p className="text-green-300 text-sm">
              Your report has been sent to <strong>{String(responses.email)}</strong> — check your inbox.
          ...
          {/* Strong CTA — book discovery call */}
          <div className="rounded-2xl border border-indigo-500/30 bg-indigo-600/10 p-8 text-center space-y-5">
            <div>
              <p className="text-indigo-400 text-sm font-semibold uppercase tracking-widest mb-2">What Happens Next</p>
              <h2 className="text-2xl font-bold text-white mb-3">
                Your roadmap is ready. Let&apos;s talk about building it.
              </h2>
              <p className="text-zinc-400 text-sm max-w-xl mx-auto leading-relaxed">
                This report shows you <em>what</em> to fix. A discovery call with Landon shows you
                <em> exactly</em> how — with a custom scope, real timeline, and specific pricing for your
                situation. It&apos;s free, 30 minutes, and no obligation.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                ...
                className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-xl transition-all text-base shadow-lg shadow-indigo-600/20"
              >
              ...
              <button
                onClick={downloadReport}
                className="inline-flex items-center justify-center gap-2 px-6 py-4 border border-zinc-700 hover:border-zinc-500 text-zinc-300 hover:text-white font-semibold rounded-xl transition-colors text-sm"
              >
            ...
            <p className="text-zinc-600 text-xs">
              Prefer email?{' '}
              <a href="mailto:landon@aimpacttechnology.com" className="text-zinc-500 hover:text-zinc-300 underline">
                landon@aimpacttechnology.com
              </a>
              {' '}· We&apos;ll reach out to <strong className="text-zinc-400">{String(responses.email)}</strong> within 1 business day regardless.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              { step: '01', title: 'We review your report', desc: 'Landon personally reads your FactFinder results before your call.' },
              { step: '02', title: 'Discovery call', desc: 'Free 30-minute call to walk through your roadmap and scope a custom build.' },
              { step: '03', title: 'Custom proposal', desc: 'You get a specific project scope, timeline, and price — no guesswork.' },
            ].map(item => (
              <div key={item.step} className="rounded-xl border border-zinc-800 bg-zinc-900/20 p-5">
                <p className="text-indigo-400/60 text-xs font-mono font-bold tracking-widest mb-2">{item.step}</p>
          ...
          <p className="text-center text-zinc-600 text-xs pb-4">
            © {new Date().getFullYear()} AiMpact Technology · All information is confidential
          </p>
        </div>
      </div>
    )
