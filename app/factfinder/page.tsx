      ...
      <div className="min-h-screen bg-[#09090B]">
        ...
        <div className="max-w-4xl mx-auto px-6 pt-28 pb-16 space-y-6">
          ...
          <div className="rounded-2xl border border-indigo-500/30 bg-indigo-600/10 p-8 text-center space-y-5">
            <div>
              ...
              <p className="text-zinc-400 text-sm max-w-xl mx-auto leading-relaxed">
                This report shows you <em>what</em> to fix. A discovery call with our team shows you
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              { step: '01', title: 'We review your report', desc: 'Our team reviews your FactFinder results before your call.' },
